#include "hyu_global_planner_debug_visualizer_node.hpp"
...
: Node("hyu_global_planner_debug_visualizer_node")
{
  declareParameters();
  loadParameters();
  buildLayerSpecs();
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<hyu_global_planner::GlobalPlannerDebugVisualizerNode>());
  rclcpp::shutdown();
  return 0;
}
