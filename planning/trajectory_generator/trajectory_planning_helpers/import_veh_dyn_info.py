...
def import_veh_dyn_info(ggv_import_path: str = None,
    ...
    ([vx, ax_max, ay_max] or [vx, ax_max, ay_max, ax_decel_max], velocity in m/s, accelerations in m/s2) and the
    ax_max_machines array containing the longitudinal acceleration limits by the electrical motors
    ([vx, ax_max_machines], velocity in m/s, acceleration in m/s2).
    ...
    if ggv_import_path is not None:
        ...
        invalid_3 = ggv[:, 1:] < 0.0    # assure positive acceleration magnitudes
