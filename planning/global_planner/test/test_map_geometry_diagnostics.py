...
SCRIPT = SRC_ROOT / "planning/global_planner/scripts/map_geometry_diagnostics.py"
BAD_WIDTH_MAP = SRC_ROOT / "eufs_graph_slam/map/map_20260713_002645.csv"
...
def test_rejects_missing_glob_when_no_inputs() -> None:
    result = run_diagnostic(["--glob", "eufs_graph_slam/map/no-such-map-*.csv"])
