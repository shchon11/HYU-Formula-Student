...
- `hyu_tmpc`: 자동 생성된 경로 매칭/TMPC 래퍼와 저장소에 포함된 OSQP 런타임
...
colcon build --packages-select hyu_tmpc_msgs hyu_tmpc
...
colcon build --packages-select \
  ...
  hyu_tmpc_output_bridge hyu_tmpc
source install/setup.zsh
```
...
```zsh
ros2 launch hyu_tmpc hyu_tmpc.launch.xml
```
...
- `hyu_tmpc/loop_rate_hz`: 기본값 `100.0`
- `hyu_tmpc/state_timeout_sec`: 기본값 `0.5`
- `hyu_tmpc/performance_trajectory_timeout_sec`: 기본값 `0.5`
- `hyu_tmpc/emergency_trajectory_timeout_sec`: 기본값 `0.5`
- `hyu_tmpc/enable_emergency`: 기본값 `false`
- `hyu_tmpc/publish_on_timeout`: 기본값 `false`
- `hyu_tmpc/steering_angle_min_rad`: 기본값 `-0.52`
- `hyu_tmpc/steering_angle_max_rad`: 기본값 `0.52`
- `hyu_tmpc/drive_force_min_n`: 기본값 `-6000.0`
- `hyu_tmpc/drive_force_max_n`: 기본값 `6000.0`
