...
//
// File: mvdc_path_matching_data.cpp
//
...
P_mvdc_path_matching_T mvdc_path_matching_P = {
  ...
  // Variable: P_VDC_EnableSafetyChecks
  ...
  // Computed Parameter: d_m_Y0
  //  Referenced by: '<S1>/d_m'

  0.0,

  // Computed Parameter: d_dot_mps_Y0
